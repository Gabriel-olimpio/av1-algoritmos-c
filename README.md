...
2.  Uma loja utiliza o Código V para compras à vista e o código P para compras a prazo. Faça um algoritmo que receba o código e o valor de 20 transações. É obrigatório o uso de uma estrutura de repetição. Calcule e mostre: 
